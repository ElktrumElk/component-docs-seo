      ...
      <div className="grid sm:grid-cols-2 gap-5 sm:gap-6 mb-10">
        <div className="feature-card">
          ...
          <p className="text-text-secondary text-sm leading-relaxed">
            <span className="highlight-green">Motion mode</span> via motion/react for
            declarative spring/tween configs, or{" "}
            <span className="highlight-amber">Legacy mode</span> via the Web Animations API
            for imperative keyframe control. Auto-detected based on which props you pass.
          </p>
        </div>
        <div className="feature-card">
          ...
          <p className="text-text-secondary text-sm leading-relaxed">
            ...
            glitch, typewriter, elastic, wave, and spiral. Animate individual letters or
            whole words with per-character keyframes and staggered timing.
          </p>
        </div>
        <div className="feature-card">
          ...
          <p className="text-text-secondary text-sm leading-relaxed">
            ...
            zoom, flip, liquid, morph, glide — with gesture triggers and AnimatePresence
            mode support for view switching.
          </p>
        </div>
        <div className="feature-card">
          ...
          <p className="text-text-secondary text-sm leading-relaxed">
            ...
            Forward size and color via the Icon wrapper, or use{" "}
            <code className="text-primary-light font-mono text-xs">Icons.icon.*</code> namespace.
          </p>
        </div>
        <div className="feature-card">
          ...
          <p className="text-text-secondary text-sm leading-relaxed">
            ...
            all <span className="highlight-green">fully typed</span> and composable via render props.
          </p>
        </div>
        <div className="feature-card">
          ...
          <p className="text-text-secondary text-sm leading-relaxed">
            ...
            <span className="highlight-green">useInstance</span> for cross-component data,
            and useStableCallback for stable references.
          </p>
        </div>
      </div>
